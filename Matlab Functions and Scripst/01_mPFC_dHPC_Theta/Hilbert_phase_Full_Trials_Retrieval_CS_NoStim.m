...
for ii = 1:size(data_phase_trials,2)
    ...
    for tt = 1:size(data_phase_trials{3,ii},3)
        ...
        set(I,'linewidth',6,'color',[.8 .0 .2])
        thetaticks([0 90 180 270])
        title({['\fontsize{16} CS-Tone: ' num2str(tt)];[];['\fontsize{14} PLV = ' num2str(data_PLV_mean_trials{2,ii}(1,tt))];[]},'color',[.8 .0 .2])
        ...
        set(I,'linewidth',6,'color',[.8 .0 .2])
        thetaticks([0 90 180 270])
        title({['\fontsize{14} PLV = ', num2str(data_PLV_mean_trials{2,ii}(2,tt))];[]},'color',[.8 .0 .2])
        ...
        set(I,'linewidth',6,'color',[.8 .0 .2])
        thetaticks([0 90 180 270])
        title({['\fontsize{14} PLV = ', num2str(data_PLV_mean_trials{2,ii}(3,tt))];[]},'color',[.8 .0 .2])
    ...
    set(I,'linewidth',6,'color',[0 0 0])
    thetaticks([0 90 180 270])
    title({['\fontsize{16} Baseline'];[];['\fontsize{14} PLV = ', num2str(data_PLV_mean_session{2,ii}(1,1))];[]})
