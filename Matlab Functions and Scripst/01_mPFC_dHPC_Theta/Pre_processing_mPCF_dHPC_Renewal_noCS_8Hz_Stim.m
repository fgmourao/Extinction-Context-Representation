...
% This because MedPC has a poor temporal resolution ( ~10ms)

% Time in samples
data.events{2,1}(:,1) = cell2mat(dataascell(1,emptyCells==0))'; % CS-Tone Start

% Define Stim Trials 
ST_CS_time               = 10*parameters.original_srate;           % Defining ST_CS time
...
....% last ITI-Trial. Normalize to 30 s after Stim 
...
Behavior_mPCF_dHPC_Renewal_noCS_8Hz_Stim
