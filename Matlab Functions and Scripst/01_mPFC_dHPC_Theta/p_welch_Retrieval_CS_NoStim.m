...
for ii = 1: size(data_2_plot{2, 1},3)
    ...
    plot(pw.full_trial.freq_baseline(pw.full_trial.parameters.frex_idx_2_12Hz),data_2_plot{2, 1}(ch1,:,ii),'linewidth',2,'Color',[.4 .4 .4])
    ...
    t(ii+11) = subplot(3,7,ii+8);
    plot(pw.full_trial.freq_baseline(pw.full_trial.parameters.frex_idx_2_12Hz),data_2_plot{2, 1}(ch2,:,ii),'linewidth',2,'Color',[.4 .4 .4])
    ...
    t(ii+21) = subplot(3,7,ii+15);
    plot(pw.full_trial.freq_baseline(pw.full_trial.parameters.frex_idx_2_12Hz),data_2_plot{2, 1}(ch3,:,ii),'linewidth',2,'Color',[.4 .4 .4])
