...
subplot(2,2,2)
boundedline(freq_v',squeeze(mean(Granger_mvgc_permutation_CS_Tone_mean(:,1,3,mvgc.parameters.frex_idx_2_12Hz),1)),squeeze(mean(Granger_mvgc_permutation_CS_Tone_SEM(:,1,3,mvgc.parameters.frex_idx_2_12Hz),1)),'LineWidth',2,'color',[.6 .6 .6],'transparency',.4);
hold on
boundedline(freq_v',squeeze(mean(Granger_mvgc_permutation_CS_Tone_mean(:,3,1,mvgc.parameters.frex_idx_2_12Hz),1)),squeeze(mean(Granger_mvgc_permutation_CS_Tone_SEM(:,3,1,mvgc.parameters.frex_idx_2_12Hz),1)),'LineWidth',2,'color',[.3 .3 .3],'transparency',.4);
ylabel({'Granger causality'},'FontWeight','bold','FontSize',12)
xlabel('(Hz)','FontSize',12)
title("5 Trials")
legend('PL --> HPC','','HPC --> PL','')
...
subplot(2,2,4)
boundedline(freq_v',squeeze(mean(Granger_mvgc_permutation_CS_Tone_mean(:,2,3,mvgc.parameters.frex_idx_2_12Hz),1)),squeeze(mean(Granger_mvgc_permutation_CS_Tone_SEM(:,2,3,mvgc.parameters.frex_idx_2_12Hz),1)),'LineWidth',2,'color',[.6 .6 .6],'transparency',.4);
hold on
boundedline(freq_v',squeeze(mean(Granger_mvgc_permutation_CS_Tone_mean(:,3,2,mvgc.parameters.frex_idx_2_12Hz),1)),squeeze(mean(Granger_mvgc_permutation_CS_Tone_SEM(:,3,2,mvgc.parameters.frex_idx_2_12Hz),1)),'LineWidth',2,'color',[.3 .3 .3],'transparency',.4);
ylabel({'Granger causality'},'FontWeight','bold','FontSize',12)
xlabel('(Hz)','FontSize',12)
title("5 Trials")
legend('IL --> HPC','','HPC --> IL','')
