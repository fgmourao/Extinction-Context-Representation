...
% Mean trials
mvgc.stats.Fint_3_6Hz_2_plot_mean(:,1)  = mvgc.stats.Fint_3_6Hz_baseline_2_plot;      % baseline - Redundant but helped in the code below
mvgc.stats.Fint_3_6Hz_2_plot_mean_(:,2) = mean(mvgc.stats.Fint_3_6Hz_CS_2_plot,2);   % CS
mvgc.stats.Fint_3_6Hz_2_plot_mean(:,3)  = mean(mvgc.stats.Fint_3_6Hz_ITI_2_plot,2);   % ITI

mvgc.stats.Fint_6_8Hz_2_plot_mean(:,1) = mvgc.stats.Fint_6_8Hz_baseline_2_plot;      % baseline - Redundant but helped in the code below
mvgc.stats.Fint_6_8Hz_2_plot_mean(:,2) = mean(mvgc.stats.Fint_6_8Hz_CS_2_plot,2);    % CS
mvgc.stats.Fint_6_8Hz_2_plot_mean(:,3) = mean(mvgc.stats.Fint_6_8Hz_ITI_2_plot,2);   % ITI

mvgc.stats.Fint_7_10Hz_2_plot_mean(:,1) = mvgc.stats.Fint_7_10Hz_baseline_2_plot;      % baseline - Redundant but helped in the code below
mvgc.stats.Fint_7_10Hz_2_plot_mean(:,2) = mean(mvgc.stats.Fint_7_10Hz_CS_2_plot,2);    % CS
mvgc.stats.Fint_7_10Hz_2_plot_mean(:,3) = mean(mvgc.stats.Fint_7_10Hz_ITI_2_plot,2);  % ITI
...
mvgc.stats.Spect_2_12Hz_2_plot_mean = squeeze(mean(mvgc.stats.Spect_2_12Hz_CS_2_plot,2));    % CS
%mvgc.stats.Spect_2_12Hz_2_plot_mean(:,3,:) = squeeze(mean(mvgc.stats.Spect_2_12Hz_ITI_2_plot,2));   % ITI
...
% CS and ITI - peak over mean trials
mvgc.stats.Fint_3_6Hz_2_plot_peak_mean_trials = max(mvgc.stats.Spect_2_12Hz_2_plot_mean(:,mvgc.parameters.frex_idx_3_6Hz),[],2);
mvgc.stats.Fint_6_8Hz_2_plot_peak_mean_trials = max(mvgc.stats.Spect_2_12Hz_2_plot_mean(:,mvgc.parameters.frex_idx_6_8Hz),[],2);
mvgc.stats.Fint_7_10Hz_2_plot_peak_mean_trials = max(mvgc.stats.Spect_2_12Hz_2_plot_mean(:,mvgc.parameters.frex_idx_7_10Hz),[],2);
