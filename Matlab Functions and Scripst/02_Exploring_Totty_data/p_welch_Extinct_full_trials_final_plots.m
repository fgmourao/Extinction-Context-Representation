...
for ii = 1:size(pw.full_trial.Pxx_TotalPower_norm_mean_first_trials,1)

    data_2_plot_extinction_mean_first_trials{ii,ms} = pw.full_trial.Pxx_TotalPower_norm_mean_first_trials{ii,1};

end


%data_2_plot_extinction_mean_last_trials = [];

for ii = 1:size(pw.full_trial.Pxx_TotalPower_norm_mean_first_trials,1)

    data_2_plot_extinction_mean_last_trials{ii,ms} = pw.full_trial.Pxx_TotalPower_norm_mean_last_trials{ii,1};
...
if ms == length(files.FilesLoaded{1, 1})
    ...
    for ii = 1:size(data_2_plot_extinction_mean_all,1)
        ...
        data_2_plot_extinction_mean_last_trials_SEM{ii,1}  = mean(cat(3,data_2_plot_extinction_mean_last_trials{ii,:}),3,'omitnan');
        data_2_plot_extinction_mean_last_trials_SEM{ii,2}  = std(cat(3,data_2_plot_extinction_mean_last_trials{ii,:}),[],3,'omitnan')./size(cat(3,data_2_plot_extinction_mean_last_trials{ii,:}),3);
    ...
    data_2_plot_mean2 = data_2_plot_extinction_mean_last_trials_SEM;
    ...
    for ii = 1:10
        ...
        boundedline(freq_v,data_2_plot{2, 1}(ch1,:,ii),data_2_plot{2, 2}(ch1,:,ii),'linewidth',2,'Color',[1 .6 .2],'transparency',.4)
        ...
        boundedline(freq_v,data_2_plot{2, 1}(ch2,:,ii),data_2_plot{2, 2}(ch2,:,ii),'linewidth',2,'Color',[1 .6 .2],'transparency',.4)
        ...
        boundedline(freq_v,data_2_plot{2, 1}(ch3,:,ii),data_2_plot{2, 2}(ch3,:,ii),'linewidth',2,'Color',[1 .6 .2],'transparency',.4)
        ...
        boundedline(freq_v,data_2_plot{2, 1}(ch1,:,ii+35),data_2_plot{2, 2}(ch1,:,ii+35),'linewidth',2,'Color',[.5, .7, 1],'transparency',.4)
        ...
        boundedline(freq_v,data_2_plot{2, 1}(ch2,:,ii+35),data_2_plot{2, 2}(ch2,:,ii+35),'linewidth',2,'Color',[.5, .7, 1],'transparency',.4)
        ...
        box off
        xlabel('Hz')
        title({['CS-Tone ' num2str(ii+35)];[]})

        t(ii+61) = subplot(6,12,ii+61);
        boundedline(freq_v,data_2_plot{2, 1}(ch3,:,ii+35),data_2_plot{2, 2}(ch3,:,ii+35),'linewidth',2,'Color',[.5, .7, 1],'transparency',.4)
    ...
    boundedline(freq_v,data_2_plot_mean1{2, 1}(ch1,:),data_2_plot_mean1{2, 2}(ch1,:),'linewidth',2,'color',[1 .6 .2],'transparency',.4 )
    hold on
    boundedline(freq_v,data_2_plot_mean2{2, 1}(ch1,:),data_2_plot_mean2{2, 2}(ch1,:),'linewidth',2,'color',[.5, .7, 1],'transparency',.4 )
    ...
    boundedline(freq_v,data_2_plot_mean1{2, 1}(ch2,:),data_2_plot_mean1{2, 2}(ch2,:),'linewidth',2,'color',[1 .6 .2],'transparency',.4 )
    hold on
    boundedline(freq_v,data_2_plot_mean2{2, 1}(ch2,:),data_2_plot_mean2{2, 2}(ch2,:),'linewidth',2,'color',[.5, .7, 1],'transparency',.4 )
    ...
    boundedline(freq_v,data_2_plot_mean1{2, 1}(ch3,:),data_2_plot_mean1{2, 2}(ch3,:),'linewidth',2,'color',[1 .6 .2],'transparency',.4 )
    hold on
    boundedline(freq_v,data_2_plot_mean2{2, 1}(ch3,:),data_2_plot_mean2{2, 2}(ch3,:),'linewidth',2,'color',[.5, .7, 1],'transparency',.4 )
