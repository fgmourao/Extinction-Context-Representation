...
for ii = 1:size(coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean,1)
    coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean{ii,2}(isempty(coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean)) = NaN;
    data_2_plot_extinction{ii,1}(:,:,:,ms) = coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean{ii,2};
end

% Frequency vector
freqv = coher_.mscohr_behavior.params.freq(coher_.mscohr_behavior.params.frex_idx_2_12Hz);
...
% for ii = 1:size(coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean,1)
%     coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean{ii,2}(isempty(coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean)) = NaN;
%     data_2_plot_retrieval{ii,1}(:,:,:,ms) = coher_.mscohr_behavior.stats.spectrum_2_12Hz_mean{ii,2};
% end
% 
% % Frequency vector
% freqv = coher_.mscohr_behavior.params.freq(coher_.mscohr_behavior.params.frex_idx_2_12Hz);
...
for ii = 1:size(data_2_plot_extinction,1)
    ...
    data_2_plot_extinction_mean_SEM{ii,4} = [freqv', fliplr(freqv')];
...
%     data_2_plot_retrieval_mean_SEM{ii,4} = [freqv', fliplr(freqv')];
% 
% end
% 
% 
...
plot(freqv,data_2_plot{1,1}(1,:),'color','k','linew',2)
fill(data_2_plot{2,4},data_2_plot{2,3}(1,:),[.4 .4 .4],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{2,1}(1,:),'color','k','linew',2)
...
plot(freqv,data_2_plot{1,1}(2,:),'color','k','linew',2)
fill(data_2_plot{2,4},data_2_plot{2,3}(2,:),[.4 .4 .4],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{2,1}(2,:),'color',[.4 .4 .4],'linew',2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
...
plot(freqv,data_2_plot{1,1}(3,:),'color','k','linew',2)
fill(data_2_plot{2,4},data_2_plot{2,3}(3,:),[.4 .4 .4],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{2,1}(3,:),'color',[.4 .4 .4],'linew',.2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
...
plot(freqv,data_2_plot{3,1}(1,:),'color',[0.6350, 0.0780, 0.1840],'linew',2)
fill(data_2_plot{4,4},data_2_plot{4,3}(1,:),[1, .4, .2],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{4,1}(1,:),'color',[1, .4, .2],'linew',2)
...
plot(freqv,data_2_plot{3,1}(2,:),'color',[0.6350, 0.0780, 0.1840],'linew',2)
fill(data_2_plot{4,4},data_2_plot{4,3}(2,:),[1, .4, .2],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{4,1}(2,:),'color',[1, .4, .2],'linew',2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
...
plot(freqv,data_2_plot{3,1}(3,:),'color',[0.6350, 0.0780, 0.1840],'linew',2)
fill(data_2_plot{4,4},data_2_plot{4,3}(3,:),[1, .4, .2],'FaceAlpha',0.3,'EdgeColor','none')
plot(freqv,data_2_plot{4,1}(3,:),'color',[1, .4, .2],'linew',2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
legend('Freezing','','Non-Freezing','')
...
plot(freqv,data_2_plot{5,1}(1,:),'color',[.2, .2, 1],'linew',2)
fill(data_2_plot{6,4},data_2_plot{6,3}(1,:),[.2, .2, 1],'FaceAlpha',0.2,'EdgeColor','none')
plot(freqv,data_2_plot{6,1}(1,:),'color',[.2, .2, 1],'linew',2)
...
plot(freqv,data_2_plot{5,1}(2,:),'color',[.2, .2, 1],'linew',2)
fill(data_2_plot{6,4},data_2_plot{6,3}(2,:),[.2, .2, 1],'FaceAlpha',0.2,'EdgeColor','none')
plot(freqv,data_2_plot{6,1}(2,:),'color',[.2, .2, 1],'linew',2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
...
plot(freqv,data_2_plot{5,1}(3,:),'color',[.2, .2, 1],'linew',2)
fill(data_2_plot{6,4},data_2_plot{6,3}(3,:),[.2, .2, 1],'FaceAlpha',0.2,'EdgeColor','none')
plot(freqv,data_2_plot{6,1}(3,:),'color',[.2, .2, 1],'linew',2)
xlabel('(Hz)','FontSize',9)
ylim([0.1 0.8])
