...
% nFFT
coher_.mscohr.params.nFFT = 2^15; %2^nextpow2(round(coher_.mscohr.params.timewin/(1000/parameters.srate)));
...
for ii = 1:length(coher_.mscohr.params.combinations)
    ...
    if ii == 1
        [coher_.mscohr.data{1,1}(ii,:),coher_.mscohr.params.freq] = mscohere(temp_1,temp_2,coher_.mscohr.params.timewinpnts,coher_.mscohr.params.overlap,coher_.mscohr.params.nFFT,parameters.decimated_srate);
    else
        coher_.mscohr.data{1,1}(ii,:) = mscohere(temp_1,temp_2,coher_.mscohr.params.timewinpnts,coher_.mscohr.params.overlap,coher_.mscohr.params.nFFT,parameters.decimated_srate);
...
coher_.coherogram_MT.params.window = 1.000;
...
coher_.coherogram_MT.params.tapers = [1 4];
coher_.coherogram_MT.params.pad = 2;
coher_.coherogram_MT.params.show = 'off';
coher_.coherogram_MT.params.cutoffs = [0 1];
...
for ii = 1:length(coher_.coherogram_MT.params.combinations)
    temp_1 = zscore(data.lfp{not1,1}(coher_.coherogram_MT.params.combinations(ii,1),B_clean{ms}(1):B_clean{ms}(2)),[],2);
    temp_2 = zscore(data.lfp{not1,1}(coher_.coherogram_MT.params.combinations(ii,2),B_clean{ms}(1):B_clean{ms}(2)),[],2);
